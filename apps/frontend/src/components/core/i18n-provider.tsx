...
import { de } from '@/locales/de'; // Korrekter Pfad zum Verzeichnis
import { en } from '@/locales/en'; // Korrekter Pfad zum Verzeichnis
import { es } from '@/locales/es'; // Korrekter Pfad zum Verzeichnis
