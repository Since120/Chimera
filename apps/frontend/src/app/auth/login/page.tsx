...
/**
 * Login-Seite für die Discord OAuth-Authentifizierung
 */
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    // Prüfen, ob ein Fehler in der URL vorhanden ist
    ...
    // Prüfen, ob eine Anmeldung im Gange ist
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50">
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-md">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">Melde dich mit deinem Discord-Account an</p>
        </div>
